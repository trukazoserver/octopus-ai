    ...
    commands: [
        {
            ...
            execute: async (args) => {
                ...
                try {
                    const { stdout } = await execAsync(`curl -s "https://api.duckduckgo.com/?q=${encodeURIComponent(query)}&format=json&no_html=1&skip_disambig=1"`, { timeout: 10000 });
        ...
        },
        {
            ...
            execute: async (args) => {
                ...
                const commonTerms = {
                    ...
                    docker: "A platform for containerizing applications for consistent deployment",
                    ...
                    async: "Asynchronous execution - code that runs without blocking the main thread",
                };
