...
const ServerSchema = Type.Object({
  ...
  transport: Type.Union([Type.Literal("auto"), Type.Literal("stdio"), Type.Literal("sse"), Type.Literal("streamable-http")], { default: "auto" }),
});

const AnthropicProviderSchema = Type.Object({
  apiKey: Type.String({ default: "" }),
  models: Type.Array(Type.String(), { default: ["claude-opus-4-6", "claude-sonnet-4-6", "claude-haiku-4-5"] }),
});

const OpenAIProviderSchema = Type.Object({
  apiKey: Type.String({ default: "" }),
  models: Type.Array(Type.String(), { default: ["gpt-4.1", "gpt-4o", "gpt-4o-mini", "o3", "o4-mini"] }),
});

const GoogleProviderSchema = Type.Object({
  apiKey: Type.String({ default: "" }),
  models: Type.Array(Type.String(), { default: ["gemini-2.5-pro", "gemini-2.5-flash"] }),
});

const ZhipuProviderSchema = Type.Object({
  apiKey: Type.String({ default: "" }),
  mode: Type.Union([Type.Literal("api"), Type.Literal("coding-plan"), Type.Literal("coding-global"), Type.Literal("global")], { default: "coding-plan" }),
  models: Type.Array(Type.String(), { default: ["glm-5.1", "glm-5", "glm-5-turbo", "glm-5v-turbo", "glm-4.6v"] }),
});
...
const DeepSeekProviderSchema = Type.Object({
  apiKey: Type.String({ default: "" }),
  models: Type.Array(Type.String(), { default: ["deepseek-chat", "deepseek-reasoner"] }),
});

const MistralProviderSchema = Type.Object({
  apiKey: Type.String({ default: "" }),
  models: Type.Array(Type.String(), { default: ["mistral-large-3", "mistral-small-4", "codestral-25-08"] }),
});

const XaiProviderSchema = Type.Object({
  apiKey: Type.String({ default: "" }),
  models: Type.Array(Type.String(), { default: ["grok-4.20-0309-reasoning", "grok-4-1-fast-reasoning"] }),
});

const CohereProviderSchema = Type.Object({
  apiKey: Type.String({ default: "" }),
  models: Type.Array(Type.String(), { default: ["command-a-03-2025", "command-a-vision-07-2025"] }),
});

const LocalProviderSchema = Type.Object({
  baseUrl: Type.String({ default: "http://localhost:11434" }),
  models: Type.Array(Type.String(), { default: ["llama3.1", "codellama", "mistral", "qwen2.5"] }),
});
...
const AiSchema = Type.Object({
  ...
  thinking: Type.Union([Type.Literal("none"), Type.Literal("low"), Type.Literal("medium"), Type.Literal("high")], { default: "medium" }),
...
const RegistrySchema = Type.Object({
  ...
  builtinSkills: Type.Array(Type.String(), { default: ["general-reasoning", "code-generation", "writing", "research"] }),
});
...
const SecuritySchema = Type.Object({
  ...
  allowedPaths: Type.Array(Type.String(), { default: ["~/Documents", "~/Desktop"] }),
