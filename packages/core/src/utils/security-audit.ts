...
import { hashPassword, verifyPassword, encrypt, decrypt, generateEncryptionKey } from './crypto.js';
...
export class SecurityAuditor {
  async runAudit(config?: { configPath?: string }): Promise<SecurityAuditResult> {
  ...
  private async checkConfigFilePermissions(configPath?: string): Promise<SecurityCheck> {
