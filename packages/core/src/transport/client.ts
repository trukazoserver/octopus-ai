...
export class TransportClient {
  ...
  private handleMessage(msg: ProtocolMessage<unknown>): void {
    ...
    if (msg.type === MessageType.event || msg.type === MessageType.stream || msg.type === MessageType.stream_end) {
  ...
  private scheduleReconnect(): void {
    ...
    const delay = this.baseReconnectInterval * Math.pow(2, this.reconnectAttempts) * jitter;
