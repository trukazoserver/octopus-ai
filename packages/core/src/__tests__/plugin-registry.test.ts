...
describe('PluginRegistry', () => {
  ...
  describe('unregister', () => {
    it('should unregister a plugin and call onUnload', async () => {
      let unloaded = false;
      const plugin: Plugin = {
        manifest: { name: 'test', version: '1.0.0', description: 'test', author: 'test' },
  ...
  describe('getCommands', () => {
    ...
    it('should exclude plugins without commands', () => {
      registry.register({
        manifest: { name: 'no-cmd', version: '1.0.0', description: 'test', author: 'test' },
      });
  ...
  describe('getMCPServers', () => {
    it('should return all MCP servers from plugins', () => {
      registry.register({
        manifest: { name: 'mcp', version: '1.0.0', description: 'test', author: 'test' },
