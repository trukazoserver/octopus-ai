...
and your library of learned skills. Be concise, helpful, and proactive.`,
        ...
        console.log(
          chalk.gray(
            `Model: ${options.model ?? system.config.ai.default}`,
          ),
        );
        console.log(
          ...
          if (input.startsWith("/")) {
            ...
            switch (cmd) {
              ...
              case "/help": {
                ...
                console.log(chalk.gray("    /clear        - Clear conversation context"));
              ...
              default: {
                console.log(
                  chalk.yellow(`  Unknown command: ${cmd}. Type /help for available commands.\n`),
                );
                break;
              }
            }
